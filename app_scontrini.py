...
# --- CREDENZIALI DIRETTE ---
# Puliamo la chiave: sostituiamo i \\n con i veri a capo
...
try:
    # Usiamo direttamente service_account_info invece di st.connection standard
    conn = st.connection("gsheets", type=GSheetsConnection, service_account_info=conn_info)
...
barcode = st.text_input("📡 Scansiona prodotto")
if barcode:
    st.write(f"Codice inserito: {barcode}")
